#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""MariaDB 校验实现 — 移植自 tools/rds/mariadb.py"""
    ...
    def check_update(self, sql_list: list):
        ...
        for sql in sql_list:
            ...
            if token == "USE":
                ...
                raise Exception(f"不合法的sql语句, 仅支持 'USE', 'CREATE TABLE', 'INSERT', 'UPDATE', 'ALTER TABLE', 'DROP INDEX', 'DROP TABLE', 'DROP VIEW', 'RENAME TABLE': {sql}")
